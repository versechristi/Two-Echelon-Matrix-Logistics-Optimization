...
class MainWindow(tk.Tk):
    ...
    def _set_matplotlib_defaults(self):
        ...
        try:
            ...
            font_prefs = ['Microsoft YaHei', 'SimHei', 'PingFang SC', 'WenQuanYi Micro Hei', 'DejaVu Sans',
            ...
            try:
                ...
                # Matplotlib might not recognize system color names like 'SystemButtonFace'
                if default_bg not in plt.colormaps() and not plt.get(f'figure.facecolor', default_bg) == default_bg:
                    default_bg = '#F0F0F0'  # Use a standard hex color as a fallback
            except:
                default_bg = '#F0F0F0'  # Fallback to a safe color
            ...
            logger.warning(f"Warning: Failed to set preferred font/style for Matplotlib: {e}")
